<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="button-action-group">
            <a href="<?= site_url('tambahstokbarang'); ?>" class="btn btn-primary"><i class="fa fa-plus-square"></i> Tambah</a>
        </div>
            ...
            <table class="table table-striped table-hover dttb">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $row['satuan']; ?></td>
                        <td>
                            <a href="<?= site_url('editstokbarang/'.$row['idstokbarang']); ?>" class="btn-sm btn-warning"><i class="fa fa-edit"></i> Edit</a>
                            <a href="javascript:void(0);" data-id="<?= $row['idstokbarang'] ?>" class="hapusstokbarang btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <div class="col-md-6">
        <div class="content-wrapper">
            ...
            <form action="<?= site_url('simpanstokbarang'); ?>" method="POST">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <div class="col-md-6">
        <div class="content-wrapper">
            ...
            <form action="<?= site_url('updatestokbarang'); ?>" method="POST">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Suplier <span class="required">*</span></label>
                                    <input type="hidden" name="idhidden" value="<?= $getdatabyid['idstokbarang'] ?? ''; ?>">
                                    <select name="idsupplier" class="dtselect2 form-control <?= form_error('idsupplier') ? 'invalid' : ''; ?>">
                                        <option value="">Pilih</option>
                                        <?php foreach( $datasupplier as $row ): 
